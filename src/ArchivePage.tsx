...
const copy = {
  ...
  km: {
    ...
    grade: "និទ្ទេស", school: "សាលារៀន", officialPage: "មើលទំព័រ PDF ផ្លូវការ", page: "ទំព័រ", subjectGrades: "និទ្ទេសតាមមុខវិជ្ជា", shareResult: "ចែករំលែកលទ្ធផល", shared: "បានចែករំលែក", linkCopied: "បានចម្លងតំណភ្ជាប់",
    ...
    provinceDetails: "ទិន្នន័យរាជធានី ខេត្ត", selectProvince: "ជ្រើសរើសរាជធានី ឬខេត្ត ដើម្បីមើលទិន្នន័យ", highSchools: "វិទ្យាល័យ", scienceCandidates: "បេក្ខជនថ្នាក់វិទ្យាសាស្ត្រ", socialCandidates: "បេក្ខជនថ្នាក់វិទ្យាសាស្ត្រសង្គម", gradeBreakdown: "ចំនួនតាមនិទ្ទេស", openProvincePdf: "បើក PDF ផ្លូវការរបស់ខេត្ត",
